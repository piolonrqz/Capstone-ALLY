            ...
            {filteredCases.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="max-w-md mx-auto mb-6 text-sm sm:text-base text-gray-600 leading-relaxed">
                  {cases.length === 0
                    ? 'Documents can only be managed for accepted cases. Once your case is accepted by a lawyer, you can upload and manage documents here.'
                    : 'No cases match your search criteria. Try adjusting your search terms or browse all available cases.'
                  }
                </p>
              </div>
            ) : (
